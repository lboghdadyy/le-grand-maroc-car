...
<body>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="profile.php?variable='<?php echo $usernameee; ?>'"><i class="fa fa-user"></i> <? echo $usernameee ?></a></li>
								<li><a href="master.php"><i class="fa fa-sign-out"></i> désconnecter</a></li>
							</ul><!--/.nav -->
						</div><!-- /.navbar-collapse -->
					</div><!--/.container-->
				</nav><!--/nav-->
	...
	<section id="featured-cars" class="featured-cars">
		<div class="container">
			...
			<div class="featured-cars-content">
				<div class="row">
					<?php
					$sql = "SELECT * FROM voitures Where Disponibility ='oui' ";
								...
								<form method="post">
									...
									<div class="row">
										<div class="col-50">
											...
											<input type="date" id="<? echo $date1_id ?>" name="debut_date" />
										</div>
										<div class="col-50">
											<label>Date De Fin :</label>
											<input type="date" id="<? echo $date2_id ?>" name="fin_date" />
										</div>
									</div>
									<div class="row">
										<div class="col-50">
											<label for="montant">Total Montant</label>
											<input onclick="calculateDays('<?php echo $prix; ?>','<? echo $date1_id ?>','<? echo $date2_id ?>','<? echo $pzip_id ?>')" type="text" id="<? echo $pzip_id ?>" name="pzip_code" readonly />
										</div>
									</div>
	...
	<script>
		function calculateDays(prix, date1, date2, pzip) {
